...
################################################################################
def loadmodel(model_dir=None,from_net=True,frozen=True,task_num = 3):
    """
    return: a base model
...
def evaluation(model_dir ,eval_dataSets,device,batch_size):
    my_eval.evaluation(model_path=model_dir, eval_dataSets=eval_dataSets,device=device,batch_size=batch_size)
