...
def main():
    ...
    if len(models_in_file) == 0 and do_train:
        ...
        ddi2010_train_data = MyDataset(features=biosses_train_data, dataset_name='ddi2010')

        # # start training
        trainer = train(base_model=model, data_Sets=[ddi2010_train_data],
    ...
    if do_eval and len(models_in_file) > 0:
        ...
        for model in models_in_file:
            ...
            evaluation(model_dir=recent_model, eval_dataSets=[ddi2010_test_data],device=device, batch_size=20)
